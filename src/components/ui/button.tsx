  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom farm variants
        hero: "bg-farm-green text-primary-foreground hover:bg-farm-green-dark shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300",
        accent: "bg-farm-yellow text-accent-foreground hover:bg-farm-yellow/80 shadow-md hover:shadow-lg",
        "outline-hero": "border-2 border-farm-green text-farm-green bg-background hover:bg-farm-green hover:text-primary-foreground shadow-md",
      },
      size: {
